...
export default (overviewMonitor = 1) => {
  ...
  const Workspace = (index) => {
    ...
    const widget = Widget.Box({
      ...
      // storing the default css values here:
      ...
      css: `
        min-width: ${1 + Math.round(monitors[1].width * userOptions.overview.scale)}px;
        min-height: ${1 + Math.round(monitors[1].height * userOptions.overview.scale)}px;
            `,
      children: [
        Widget.EventBox({
          hexpand: true,
