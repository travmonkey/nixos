                ...
                children: [
                    ...
                    ImageAction({
                        ...
                        action: (self) => {
                            ...
                            const saveCommand = `mkdir -p $(xdg-user-dir PICTURES)/.homework/${data.is_nsfw ? 'notes/' : ''}${userOptions.sidebar.image.saveInFolderByTags ? tagDirectory : ''} && curl -L -o $(xdg-user-dir PICTURES)/.homework/${data.is_nsfw ? 'notes/' : ''}${userOptions.sidebar.image.saveInFolderByTags ? (tagDirectory + '/') : ''}${data.md5}.${fileExtension} '${data.file_url}'`;
