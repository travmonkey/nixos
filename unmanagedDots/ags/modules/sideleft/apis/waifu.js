                ...
                Box({
                    ...
                    children: [
                        ...
                        ImageAction({
                            ...
                            icon: 'save',
                            action: (self) => {
                                execAsync(['bash', '-c', `mkdir -p $(xdg-user-dir PICTURES)/.homework${thisBlock.attribute.isNsfw ? '/notes' : ''} && cp ${thisBlock.attribute.imagePath} $(xdg-user-dir PICTURES)/.homework${thisBlock.attribute.isNsfw ? '/notes/' : ''}`])
